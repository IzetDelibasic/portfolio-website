import { FaAward, FaGamepad, FaRegLightbulb } from "react-icons/fa";
...
export const competitionConstant = [
  ...
  {
    competitionTitle: "FIT MOSTAR CODING CHALLENGE - v.16",
    competitionDescription:
  ...
  {
    competitionTitle: "FIT MOSTAR GAME DEVELOPMENT - v.17",
    competitionDescription:
      "Participant in the FIT CC game development competition, where we created an open-world survival game called WildEscape.",
    icon: FaGamepad,
    href: "",
  },
