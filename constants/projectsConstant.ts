...
export const projectsConstant = [
  {
    ...
    description:
      "This is my first project, where I worked for BlueDuck IT Services & Solutions company and built an app for Sumatherm Company using NextJS. I used TypeScript and Tailwind CSS. I learned to work with reusable components, constants, and other features for faster page speed.",
    image: sumathermImage,
  ...
  {
    id: 3,
    title: "Wildescape - Survival game",
    description:
